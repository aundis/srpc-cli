...
// Package tool is a harness for writing Go mi.
package main
...
// The original Version of the file is in golang.org/x/mi/internal/tool.
//
...
// add cmd line arguments and handling for the common profiling methods.
type Profile struct {
...
type Application interface {
	// PkgName returns the application's name. It is used in help and error messages.
	Name() string
	// Most of the help usage is automatically generated, this string should only
	// describe the contents of non flag arguments.
	Usage() string
	// ShortHelp returns the one line overview of the cmd.
	ShortHelp() string
...
// to trigger printing of the cmd line help.
...
// triggers printing of the cmd line help.
// In general you should use this when generating cmd line validation errors.
